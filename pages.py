...
:root {
  ...
  --white-purple: #7B61FF;
  --white-red: #FF2352;
  --white-success: #16A34A;
  --white-warning: #F59E0B;
  --white-danger: #DC2626;
  --text-primary: #0F172A;
...
.orb-1{width:500px;height:500px;background:var(--white-blue);top:-200px;left:-100px;opacity:.18}
.orb-2{width:400px;height:400px;background:var(--white-purple);bottom:-150px;right:-120px;opacity:.14;animation-delay:-6s}
.orb-3{width:350px;height:350px;background:var(--white-red);top:40%;right:30%;opacity:.08;animation-delay:-3s}
...
.particle:nth-child(1){width:3px;height:3px;background:var(--white-blue);top:20%;left:15%;animation-duration:14s;opacity:.5}
.particle:nth-child(2){width:2px;height:2px;background:var(--white-purple);top:60%;left:25%;animation-duration:18s;animation-delay:-5s;opacity:.4}
.particle:nth-child(3){width:4px;height:4px;background:var(--white-red);top:30%;left:70%;animation-duration:16s;animation-delay:-8s;opacity:.35}
.particle:nth-child(4){width:2px;height:2px;background:var(--white-blue);top:75%;left:55%;animation-duration:20s;animation-delay:-2s;opacity:.45}
.particle:nth-child(5){width:3px;height:3px;background:var(--white-purple);top:10%;left:45%;animation-duration:15s;animation-delay:-11s;opacity:.3}
.particle:nth-child(6){width:2px;height:2px;background:var(--white-red);top:85%;left:80%;animation-duration:22s;animation-delay:-7s;opacity:.4}
.particle:nth-child(7){width:3px;height:3px;background:var(--white-blue);top:45%;left:35%;animation-duration:17s;animation-delay:-4s;opacity:.35}
.particle:nth-child(8){width:2px;height:2px;background:var(--white-purple);top:55%;left:65%;animation-duration:19s;animation-delay:-9s;opacity:.3}
...
/* White Logo */
.white-logo{display:flex;align-items:center;justify-content:center;margin-bottom:28px;position:relative;z-index:1}
.white-svg{width:80px;height:80px;filter:drop-shadow(0 4px 12px rgba(43,127,255,.3))}
.white-body{fill:url(#white-body-grad)}
.white-leg{fill:none;stroke:url(#white-leg-grad);stroke-width:3;stroke-linecap:round;animation:legPulse 2s ease-in-out infinite}
.white-leg:nth-child(even){animation-delay:-1s}
...
.login-title .gradient-text{background:linear-gradient(90deg,var(--white-blue),var(--white-purple),var(--white-red));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
.field-label i{font-size:13px;color:var(--white-purple)}
...
.input-wrap input:focus{border-color:var(--white-blue);background:rgba(255,255,255,.9);box-shadow:0 0 0 4px rgba(43,127,255,.1)}
...
input:focus ~ .input-icon{color:var(--white-blue)}
...
.eye-toggle:hover{color:var(--white-purple);background:rgba(123,97,255,.08)}
/* Error */
.error-msg{display:none;align-items:center;gap:8px;background:rgba(255,35,82,.08);border:1px solid rgba(255,35,82,.2);border-radius:var(--radius-sm);padding:11px 14px;margin-bottom:18px;color:var(--white-danger);font-size:12px;position:relative;z-index:1}
...
.hint-value{font-family:'Inter',monospace;font-size:14px;font-weight:700;color:var(--white-blue);background:rgba(43,127,255,.1);border:1px solid rgba(43,127,255,.2);padding:4px 14px;border-radius:10px;cursor:pointer;transition:all .2s ease;letter-spacing:.06em}
...
.login-btn::before{content:'';position:absolute;inset:0;background:linear-gradient(90deg,var(--white-blue),var(--white-purple),var(--white-red));transition:opacity .3s}
.login-btn::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,var(--white-red),var(--white-purple),var(--white-blue));opacity:0;transition:opacity .3s}
...
.login-footer .dot{width:5px;height:5px;border-radius:50%;background:var(--white-purple);display:inline-block;margin:0 6px}
/* Responsive */
@media(max-width:480px){
  .login-card{padding:32px 24px 30px}
  .login-title{font-size:24px}
  .white-svg{width:64px;height:64px}
}
</style>
</head>
...
<div class="login-wrap">
  <div class="login-card">
    <div class="white-logo">
      <svg class="white-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="white-body-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style="stop-color:#2B7FFF"/>
            <stop offset="50%" style="stop-color:#7B61FF"/>
            <stop offset="100%" style="stop-color:#FF2352"/>
          </linearGradient>
          <linearGradient id="white-leg-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style="stop-color:#2B7FFF"/>
            <stop offset="100%" style="stop-color:#7B61FF"/>
          </linearGradient>
        </defs>
        <!-- Legs -->
        <path class="white-leg" d="M50,50 L10,15"/>
        <path class="white-leg" d="M50,50 L15,50"/>
        <path class="white-leg" d="M50,50 L10,85"/>
        <path class="white-leg" d="M50,50 L90,15"/>
        <path class="white-leg" d="M50,50 L85,50"/>
        <path class="white-leg" d="M50,50 L90,85"/>
        <path class="white-leg" d="M50,50 L30,5"/>
        <path class="white-leg" d="M50,50 L70,5"/>
        <!-- Body -->
        <ellipse class="white-body" cx="50" cy="46" rx="18" ry="22"/>
        <!-- Head -->
        <ellipse class="white-body" cx="50" cy="23" rx="12" ry="10"/>
        <!-- Eyes -->
...
(function(){
  ...
  var saved=localStorage.getItem('white-theme')||'light';
...
.nav-item.active{background:linear-gradient(135deg,rgba(123,97,255,.1),rgba(43,127,255,.08));color:var(--white-purple);border-right-color:var(--white-purple);font-weight:700}
.nav-item.active i{color:var(--white-purple)}
.nav-badge{margin-right:auto;background:rgba(43,127,255,.12);color:var(--white-blue);font-size:9px;padding:2px 7px;border-radius:20px;font-weight:700}
...
.logout-btn{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;padding:9px;border:none;border-radius:var(--radius-sm);background:rgba(255,35,82,.06);color:var(--white-red);font-family:inherit;font-size:11.5px;font-weight:600;cursor:pointer;transition:all .2s;margin-top:6px;border:1px solid rgba(255,35,82,.1)}
...
.topbar-title i{color:var(--white-blue);font-size:21px}
...
.bell-btn:hover{background:rgba(43,127,255,.12);color:var(--white-blue)}
.bell-btn::after{content:'';position:absolute;top:8px;left:8px;width:7px;height:7px;border-radius:50%;background:var(--white-red);border:2px solid var(--surface)}
...
.btn-ghost{background:rgba(43,127,255,.06);color:var(--white-blue);border:1px solid rgba(43,127,255,.15)}
.btn-ghost:hover{background:rgba(43,127,255,.12)}
.btn-danger{background:rgba(255,35,82,.06);color:var(--white-red);border:1px solid rgba(255,35,82,.15)}
...
.btn-purple{background:rgba(123,97,255,.08);color:var(--white-purple);border:1px solid rgba(123,97,255,.15)}
...
.badge-blue{background:rgba(43,127,255,.1);color:var(--white-blue)}
.badge-green{background:rgba(22,163,74,.1);color:var(--success)}
.badge-red{background:rgba(255,35,82,.1);color:var(--white-red)}
.badge-purple{background:rgba(123,97,255,.1);color:var(--white-purple)}
.badge-amber{background:rgba(245,158,11,.1);color:var(--warning)}
.dot{width:6px;height:6px;border-radius:50%;flex-shrink:0;display:inline-block}
.dot-green{background:var(--success)}
.dot-red{background:var(--white-red)}
.dot-blue{background:var(--white-blue)}
...
.stat-icon.blue{background:rgba(43,127,255,.1);color:var(--white-blue)}
.stat-icon.purple{background:rgba(123,97,255,.1);color:var(--white-purple)}
.stat-icon.green{background:rgba(22,163,74,.1);color:var(--success)}
.stat-icon.red{background:rgba(255,35,82,.1);color:var(--white-red)}
...
.server-title i{color:var(--white-blue);font-size:17px}
...
.pb-vless{background:rgba(43,127,255,.1);color:var(--white-blue)}
.pb-vmess{background:rgba(123,97,255,.1);color:var(--white-purple)}
.pb-trojan{background:rgba(255,35,82,.1);color:var(--white-red)}
...
.status-dot.expired{color:var(--white-red)}
...
.exp-bad{background:rgba(255,35,82,.1);color:var(--white-red)}
...
.modal-title i{color:var(--white-purple);font-size:18px}
...
.modal-close:hover{background:rgba(255,35,82,.1);color:var(--white-red);border-color:rgba(255,35,82,.2)}
...
.form-field label i{color:var(--white-purple);font-size:13px}
...
.form-input:focus{border-color:var(--white-blue);box-shadow:0 0 0 3px rgba(43,127,255,.1)}
...
.form-select:focus{border-color:var(--white-blue)}
...
.cfg-code{background:rgba(15,23,42,.06);border:1px solid var(--border);border-radius:var(--radius-sm);padding:11px 13px;font-family:'Inter',monospace;font-size:10px;color:var(--white-blue);word-break:break-all;line-height:1.7;max-height:80px;overflow-y:auto;margin-bottom:10px}
...
.log-icon-s.info{background:rgba(43,127,255,.1);color:var(--white-blue)}
...
.log-icon-s.err{background:rgba(255,35,82,.1);color:var(--white-red)}
...
.toast.err{border-color:rgba(255,35,82,.3);background:rgba(255,35,82,.06);color:var(--white-red)}
...
.chart-title i{color:var(--white-blue)}
...
<div class="bg-particles">
  <div class="bg-p" style="width:4px;height:4px;background:var(--white-blue);top:10%;left:20%;animation-duration:18s"></div>
  <div class="bg-p" style="width:3px;height:3px;background:var(--white-purple);top:70%;left:40%;animation-duration:22s;animation-delay:-6s"></div>
  <div class="bg-p" style="width:5px;height:5px;background:var(--white-red);top:40%;left:70%;animation-duration:16s;animation-delay:-10s"></div>
  <div class="bg-p" style="width:3px;height:3px;background:var(--white-blue);top:80%;left:15%;animation-duration:20s;animation-delay:-3s"></div>
  <div class="bg-p" style="width:4px;height:4px;background:var(--white-purple);top:25%;left:55%;animation-duration:19s;animation-delay:-8s"></div>
</div>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    ...
    <div><div class="sidebar-logo-text">White Panel</div><div class="sidebar-logo-sub">White Gateway</div></div>
  </div>
  <div class="sidebar-nav">
    ...
    <div class="nav-item" data-page="logout" style="color:var(--white-red)"><i class="ti ti-logout"></i> خروج</div>
  </div>
...
<script>
/* ============ GLOBALS ============ */
var isDark=localStorage.getItem('white-theme')==='dark';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('white-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
function renderUsersTable(links,tableId){
  ...
  tbody.innerHTML=links.map(function(l){
    ...
    var bc=pct>90?'var(--white-red)':pct>70?'var(--warning)':'var(--white-blue)';
    ...
    if(d.connected){
      ...
      if(d.last_sync){
        ...
        ls.innerHTML = '<div style="font-size:13px;color:var(--text-secondary)">زمان: '+syncTime+'</div>' +
          ...
          (syncError ? '<div style="font-size:13px;color:var(--white-red);margin-top:4px">خطا: '+esc(syncError)+'</div>' : '');
      }
    }else{
...
.bg-orb:nth-child(1){{width:450px;height:450px;background:var(--white-blue);top:-150px;left:-100px}}
.bg-orb:nth-child(2){{width:350px;height:350px;background:var(--white-purple);bottom:-100px;right:-80px;animation-delay:-7s}}
...
.theme-toggle:hover{{background:rgba(43,127,255,.1);color:var(--white-blue)}}
/* Info card */
...
.section-title i{{color:var(--white-blue);font-size:15px}}
...
.cfg-status.no{{background:rgba(255,35,82,.1);color:var(--white-red)}}
.cfg-code{{background:rgba(15,23,42,.05);border:1px solid var(--border);border-radius:var(--radius);padding:12px 14px;font-family:'Inter',monospace;font-size:10px;color:var(--white-blue);word-break:break-all;line-height:1.7;margin-bottom:10px;max-height:80px;overflow-y:auto}}
[data-theme="dark"] .cfg-code{{background:rgba(0,0,0,.2);color:#60A5FA}}
...
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(90deg,var(--white-blue),var(--white-purple));color:#fff;box-shadow:0 4px 14px rgba(43,127,255,.25)}}
...
.lock-icon{{width:64px;height:64px;border-radius:18px;background:rgba(43,127,255,.1);border:1px solid rgba(43,127,255,.2);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;font-size:28px;color:var(--white-blue)}}
...
.lock-input:focus{{border-color:var(--white-blue);box-shadow:0 0 0 4px rgba(43,127,255,.1)}}
...
.lock-err{{color:var(--white-red);font-size:11px;margin-bottom:10px;min-height:18px}}
/* Toast */
...
<div class="wrap">
  <div class="top-bar">
    <div class="brand">
      ...
      <div><div class="brand-name">White Panel</div><div class="brand-sub">White Gateway</div></div>
    </div>
  ...
  <div class="footer">White Panel · White Gateway</div>
</div>
<script>
var UUID_KEY='{uuid_key}',savedPw='',currentData=null;
var isDark=localStorage.getItem('white-pub-theme')==='dark';
...
function toggleTheme(){{isDark=!isDark;localStorage.setItem('white-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
