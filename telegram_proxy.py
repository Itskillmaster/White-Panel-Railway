...
logger = logging.getLogger("White-TelegramProxy")
SECRET_RE = re.compile(r"^[0-9a-fA-F]{32}$")
BASE = Path(os.environ.get("WHITE_DATA_DIR", "/data"))
...
def derive_secret_from_uuid(config_uuid: str, salt: str = "white-tg-proxy") -> str:
